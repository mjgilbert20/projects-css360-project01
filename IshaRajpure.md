...
**Incremental** - The dentist has established their core and uncompromisable requirements as well as the possibility of future additions, thus this software can be developed incrementally. Also, they seem to be looking for just a product in hand initially, which doesn't have to be complete, so the incremental model will allow for new updates.

### Scenario 03: Nuclear Power Plant

**Waterfall** - The waterfall model is an appropriate choice for this product because the company is looking for a secure critical system that can last for a long time. And the enormity of this project requires multiple types of teams who will need to work with non-changing requirements.
...
**Waterfall** - The waterfall model will be able to support the complexity and scale of this product. Also, because this is an embedded system, the company will have to thoroughly plan, and there will be multiple types of teams working this project, so writing detailed requirements early on is a necessity.
