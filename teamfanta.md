...
* **Other Models Considered**: Incremental development, specifically agile methods, was considered since it’s a live web application with changes needed constantly. We ultimately rejected this model due to system degradation with additional increments.
* **Key Aspects**: 
...
* **Other Models Considered**: Waterfall since the request has clearly outlined requirements. We ultimately rejected this model because the requirements can be further added to or developed in the process. 
* **Key Aspects**: 
...
* **Other Models Considered**: The spiral model of development was considered to reduce the risks of the waterfall model due to its rigidity, but ultimately this isn’t a project where multiple prototypes can be developed and must be finalized. Failure would be catastrophic 👀
* **Key Aspects**: 
...
* **Other Models Considered**: 
  * Integration - similar solutions were developed by the company and can be integrated to save time and reduce repetitive work. However, with integration, specifications may not be prioritized.
  * Incremental - large framework decisions can be made earlier in development however this project requires emphasis on the specifications for the final deliverable 
  * Waterfall - project is a response to a long list of specifications, with a set number of engineers to distribute the work across. 
* **Key Aspects**: 
...
* **Other Models Considered**: 
  * Incremental - it sounds like the team will need feedback throughout development to apply previous systems. However, due to the complexity of this project, it may be unrealistic to push out the project in versions.
  * Integration and configuration - utilization of previous equipment and technology, however, this project is not centered on customization of previous software for development. 
* **Key Aspects**: 
...
* **Other Models Considered**: 
   * Waterfall - Not a good fit because game requirements and features will change after playtesting
* **Key Aspects**: 
...
* **Other Models Considered**: **Waterfall** was considered due to the expense of the project and the consideration of stakeholders in terms of the health of people residing in the countries the project is being implemented in. However, this project has changing requirements and potential for more acquired resources. 
* **Key Aspects**: 
  * Expansion
